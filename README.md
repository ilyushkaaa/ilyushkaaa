...
Мои проекты
* 🍿 Сервис подбора и оценки фильмов "Movieworld" (аналог "Кинопоиск"). [Ссылка на репозиторий на Gitlab](https://gitlab.com/ilyushkaaa/movieworld.git)
📱 Социальная сеть - форум, аналог Reddit. [Ссылка на репозиторий](https://github.com/ilyushkaaa/redditclone.git)
⚽ Веб - сервис Российской футбольной Премьер - лиги. [Ссылка на репозиторий](https://github.com/ilyushkaaa/RPL.git)
🎓 Репозиторий с домашними работами курса по Go компании VK (в папках 99_hw каждой темы) [Ссылка на репозиторий](https://gitlab.com/ilyushkaaa/lectures.git)
<br>
